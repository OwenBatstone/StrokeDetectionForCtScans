...
class DotPainter extends CustomPainter { //for making the dot based off the normalized coordinates
  ...
  @override
  bool shouldRepaint(covariant DotPainter oldDelegate) { //if dot moves repaint
