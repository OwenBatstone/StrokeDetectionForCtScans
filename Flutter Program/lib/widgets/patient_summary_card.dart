...
class PatientSummaryCard extends StatelessWidget {
  //for showing the final prediction
  final PatientSummary summary;
  const PatientSummaryCard({
    required this.summary,
  }); //summary data about patient
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text( //text from passed summary object
